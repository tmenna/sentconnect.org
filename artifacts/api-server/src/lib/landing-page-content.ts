  ...
  if (!ensurePromise) {
    ensurePromise = pool.query(`
      CREATE TABLE IF NOT EXISTS landing_page_content (
        ...
        how_it_works_heading text NOT NULL DEFAULT 'Connecting churches and field teams',
    ...
    `).then(() => pool.query(`
      ALTER TABLE landing_page_content
        ...
        ADD COLUMN IF NOT EXISTS how_it_works_heading text NOT NULL DEFAULT 'Connecting churches and field teams',
