    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "3.5vh 5vw 3vh" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.8vw", marginBottom: "2vh" }}>
          ...
          <span style={{ color: "#0268CE", fontSize: "1vw", fontWeight: 700, letterSpacing: "0.08em" }}>GUIDE STEP 03 · SHARING</span>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2.5vw", flex: 1 }}>
          <div style={{ background: "#FFFFFF", borderRadius: 16, padding: "3.5vh 3vw", border: "1px solid #BFDBFE", boxShadow: "0 4px 16px rgba(2,104,206,0.08)", display: "flex", flexDirection: "column", gap: "2vh" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
              <div style={{ width: "5vh", height: "5vh", minWidth: "5vh", borderRadius: 12, background: "#EFF6FF", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "2.5vh" }}>🔗</div>
              <div>
                <div style={{ color: "#0268CE", fontSize: "0.85vw", fontWeight: 700, letterSpacing: "0.07em" }}>ONLINE</div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5vh" }}>
              {[
                ...
                <div key={i} style={{ display: "flex", gap: "1vw", alignItems: "flex-start" }}>
                  <div style={{ width: "2.2vh", height: "2.2vh", minWidth: "2.2vh", borderRadius: "50%", background: "#EFF6FF", color: "#0268CE", fontSize: "0.8vw", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", marginTop: "0.3vh" }}>{i + 1}</div>
                  <span style={{ color: "#475569", fontSize: "1.1vw", lineHeight: 1.55 }}>{text}</span>
                </div>
              ))}
            </div>
            <div style={{ background: "#EFF6FF", borderRadius: 10, padding: "1.2vh 1.5vw", marginTop: "auto" }}>
              <div style={{ color: "#94A3B8", fontSize: "0.85vw", fontWeight: 600, marginBottom: "0.5vh" }}>LINK FORMAT</div>
              <div style={{ color: "#0047A8", fontSize: "1.1vw", fontWeight: 600 }}>[org].sentconnect.org/post/[id]</div>
            </div>
          </div>
