      ...
      <div style={{ flex: 1, display: "flex", gap: "4vw", padding: "3.5vh 5vw 3vh", alignItems: "flex-start" }}>
        <div style={{ flex: "0 0 38%", display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.8vw", marginBottom: "2.5vh" }}>
            ...
            <span style={{ color: "#0268CE", fontSize: "1vw", fontWeight: 700, letterSpacing: "0.08em" }}>FEATURE · POST COMPOSER</span>
          </div>
          ...
          <div style={{ background: "#EFF6FF", borderRadius: 12, padding: "2vh 1.8vw", border: "1px solid #BFDBFE" }}>
            ...
            <div style={{ color: "#1E40AF", fontSize: "1.1vw", lineHeight: 1.55 }}>Tap the compose button at the top of your feed to open the post editor.</div>
          </div>
        </div>

        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "1.5vh", justifyContent: "center", height: "100%" }}>
          {fields.map(f => (
            <div key={f.label} style={{ background: "#FFFFFF", borderRadius: 12, padding: "1.8vh 2vw", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", border: "1px solid #E8EEF8", display: "flex", alignItems: "center", gap: "1.5vw" }}>
