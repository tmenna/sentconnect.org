        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-0.5 sm:gap-1 mt-3 pt-3 flex-wrap" style={{ borderTop: "1px solid #F1F5F9" }}>
            ...
            <button
              ...
              style={{ color: "#6B7280" }}
              onMouseEnter={e => { e.currentTarget.style.color = "#009E7A"; e.currentTarget.style.background = "#E6F7F3"; }}
            ...
            <button
              ...
              disabled={posting || files.length >= 6}
              className="flex items-center gap-1.5 px-2 sm:px-3 py-1.5 rounded-full text-[13px] font-medium transition-all duration-150 disabled:opacity-40"
              style={{ color: files.some(f => isVideo(f)) ? "#009E7A" : "#6B7280", background: files.some(f => isVideo(f)) ? "#E6F7F3" : "" }}
              onMouseEnter={e => { if (!files.some(f => isVideo(f))) { e.currentTarget.style.color = "#009E7A"; e.currentTarget.style.background = "#E6F7F3"; } }}
            ...
            <button
              ...
              style={{ color: showLocation ? "#009E7A" : "#6B7280", background: showLocation ? "#E6F7F3" : "" }}
              onMouseEnter={e => { if (!showLocation) { e.currentTarget.style.color = "#009E7A"; e.currentTarget.style.background = "#E6F7F3"; } }}
            ...
            <button
              ...
              style={{
                background: isMissionMoment ? "#E6F7F3" : "transparent",
                color: isMissionMoment ? "#009E7A" : "#6B7280",
                border: isMissionMoment ? "1px solid #E9D5FF" : "1px solid transparent",
              }}
              onMouseEnter={e => { if (!isMissionMoment) { e.currentTarget.style.color = "#009E7A"; e.currentTarget.style.background = "#E6F7F3"; } }}
              onMouseLeave={e => { if (!isMissionMoment) { e.currentTarget.style.color = "#6B7280"; e.currentTarget.style.background = ""; } }}
            >
              <Star className={cn("h-4 w-4", isMissionMoment ? "fill-[#009E7A] text-[#009E7A]" : "")} />
            ...
            <button
              ...
              style={{ background: "#009E7A", height: "40px", boxShadow: canPost ? "0 4px 14px rgba(154,39,255,0.28)" : "none", letterSpacing: "-0.02em" }}
              onMouseEnter={e => { if (canPost) { e.currentTarget.style.background = "#7B1FCC"; e.currentTarget.style.transform = "translateY(-1px)"; } }}
              onMouseLeave={e => { e.currentTarget.style.background = "#009E7A"; e.currentTarget.style.transform = ""; }}
            >
