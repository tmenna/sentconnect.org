      ...
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "py-2 shadow-md" : "py-3"}`} style={{ background: BLUE }}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex md:hidden items-center gap-2">
            <a href="https://demo.sentconnect.org/" className="text-xs font-bold text-white px-3 py-1.5 rounded-full" style={{ background: "#FF7A00", textDecoration: "none", boxShadow: "0 1px 6px rgba(0,0,0,0.18)" }}>Demo</a>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  style={{ background: "#FF7A00", textDecoration: "none", boxShadow: "0 4px 20px rgba(255,122,0,0.32)" }}
                  onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.background = "#E86E00"; el.style.transform = "translateY(-2px)"; el.style.boxShadow = "0 10px 30px rgba(255,122,0,0.42)"; }}
                  onMouseLeave={e => { const el = e.currentTarget as HTMLElement; el.style.background = "#FF7A00"; el.style.transform = "translateY(0)"; el.style.boxShadow = "0 4px 20px rgba(255,122,0,0.32)"; }}
                >
      ...
      <header style={{ position: "sticky", top: 0, zIndex: 50, background: BLUE }}>
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 sm:px-6" style={{ height: 80 }}>
          ...
          <div className="flex sm:hidden items-center gap-2">
            <a
              href="https://demo.sentconnect.org/"
              style={{ fontSize: 12, fontWeight: 700, color: "#fff", background: "#FF7A00", padding: "6px 12px", borderRadius: 999, textDecoration: "none", boxShadow: "0 1px 6px rgba(0,0,0,0.18)" }}
            >Demo</a>
            <a
              href={lpContent.headerPrimaryCtaHref}
              onClick={e => handleCtaClick(e, lpContent.headerPrimaryCtaHref)}
