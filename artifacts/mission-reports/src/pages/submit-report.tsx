          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div style={{ padding: "16px 20px 0" }}>
              <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                <Avatar style={{ width: 42, height: 42, flexShrink: 0 }}>
                  ...
                  <AvatarFallback style={{ background: "#0059D6", color: "#fff", fontSize: 14, fontWeight: 700 }}>{initials}</AvatarFallback>
                </Avatar>
            ...
            <FormField
              ...
              render={({ field }) => (
                <div style={{ padding: "12px 20px 0" }}>
                  ...
                  >
                    <BookOpen style={{ width: 16, height: 16, color: field.value ? "#0059D6" : "#94A3B8", flexShrink: 0 }} />
                    <span style={{ flex: 1, fontSize: 13, fontWeight: 600, color: field.value ? "#0059D6" : "#374151" }}>Mark as Mission Moment</span>
                    <div style={{ width: 36, height: 20, borderRadius: 999, background: field.value ? "#0059D6" : "#E2E8F0", position: "relative", flexShrink: 0, transition: "background 0.2s" }}>
            ...
            <div style={{ padding: "16px 20px 18px", display: "flex", alignItems: "center", gap: 10, borderTop: "1px solid #F1F5F9", marginTop: 14 }}>
              ...
              <Button
                ...
                style={{ flex: 1, height: 40, fontSize: 14, fontWeight: 700, borderRadius: 10, background: "#0059D6", display: "flex", alignItems: "center", justifyContent: "center", gap: 7, boxShadow: "0 3px 12px rgba(0,89,214,0.3)", letterSpacing: "-0.01em", border: "none" }}
              >
