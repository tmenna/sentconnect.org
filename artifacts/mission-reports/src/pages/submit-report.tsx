          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div style={{ padding: "16px 20px 18px", display: "flex", alignItems: "center", gap: 10, borderTop: "1px solid #F1F5F9", marginTop: 14 }}>
              ...
              <Button
                ...
                style={{ flex: 1, height: 40, fontSize: 14, fontWeight: 700, borderRadius: 10, background: "#1085FD", display: "flex", alignItems: "center", justifyContent: "center", gap: 7, boxShadow: "0 3px 12px rgba(0,89,214,0.3)", letterSpacing: "-0.01em", border: "none" }}
              >
