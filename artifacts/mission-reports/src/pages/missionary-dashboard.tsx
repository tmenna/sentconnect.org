    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
      ...
      <div style={{ paddingBottom: 4 }}>
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 style={{ fontSize: 26, fontWeight: 700, color: "#3DC9A8", letterSpacing: "-0.03em", lineHeight: 1.15, marginBottom: 6 }}>
              Missions Feed
            </h1>
          ...
          <div className="flex items-center gap-2 flex-shrink-0 mt-1">
            ...
            {missionMoments.length > 0 && (
              <span className="inline-flex items-center gap-1" style={{ fontSize: 12, fontWeight: 700, color: "#3DC9A8", background: "#E6FAF6", border: "1px solid #E9D5FF", borderRadius: 999, padding: "4px 12px" }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                border: "none",
                borderBottom: active ? "2px solid #3DC9A8" : "2px solid transparent",
        ...
        <div className="bg-white rounded-2xl py-20 text-center" style={{ border: "1.5px dashed #CBD5E1" }}>
          {activeTab === "moments" ? (
            <>
              ...
              <p className="font-semibold text-[16px]" style={{ color: "#3DC9A8" }}>No Mission Moments yet</p>
            ...
            <>
              ...
              <p className="font-semibold text-[16px]" style={{ color: "#3DC9A8" }}>No posts yet</p>
