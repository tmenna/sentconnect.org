    ...
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="w-full max-w-md bg-white rounded-2xl px-8 py-10 text-center"
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          <img src={logoWhite} alt="SentConnect" className="h-20 md:h-24" style={{ width: "auto", maxWidth: 300, display: "block", filter: "brightness(0)" }} />
        </div>
        ...
        {status === "error" && (
          <>
            ...
            <p className="text-sm text-gray-500 mb-6">
              ...
              <a href="mailto:teki@holteksolutions.com" className="font-semibold" style={{ color: BLUE, textDecoration: "none" }}>teki@holteksolutions.com</a>{" "}
              if this persists.
            </p>
