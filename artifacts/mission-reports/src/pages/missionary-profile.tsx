    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-5 py-2">
        <Avatar className="h-16 w-16 flex-shrink-0 rounded-xl" style={{ border: "1.5px solid #E8EEF8" }}>
          ...
          <AvatarFallback className="text-2xl font-bold rounded-xl" style={{ background: "#E6FAF6", color: "#3DC9A8" }}>
            {user.name.charAt(0)}
          </AvatarFallback>
        </Avatar>
        ...
        <div className="hidden sm:flex items-center gap-2 flex-shrink-0 mt-1">
          <span className="inline-flex items-center gap-1.5" style={{ fontSize: 12, fontWeight: 600, color: "#3DC9A8", background: "#E6FAF6", border: "1px solid #A7EFE0", borderRadius: 999, padding: "4px 12px" }}>
      ...
      {/* Filter Tabs */}
      <div className="flex items-center" style={{ borderBottom: "1px solid #A7EFE0" }}>
        {([
