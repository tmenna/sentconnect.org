  ...
  if (authLoading || loadingUser) {
    return (
      <div className="space-y-5">
        <div className="rounded-2xl h-24 animate-pulse" style={{ background: "linear-gradient(135deg, #004EA8 0%, #006BD5 100%)" }} />
  ...
  return (
    <div className="space-y-5">
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #004EA8 0%, #006BD5 100%)" }}
      >
